...
public class Alert {
    ...
    /**
     * to create warning alert and use stage
     *
     ...
     * @param alertCallback alert callback for button
     */
    public static void createAlertConfirmation(Stage primaryStage, String title, String headerText, String contentText, AlertCallback alertCallback) {
        javafx.scene.control.Alert alert = new javafx.scene.control.Alert(javafx.scene.control.Alert.AlertType.CONFIRMATION);
        alert.setTitle(title);
